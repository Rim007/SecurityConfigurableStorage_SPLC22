...
\setlength{\fixedColWidth}{1.55em}
\usepackage{multicol}
\usepackage{multirow}
\usepackage{natbib}
\usepackage{hyperref}
...
Overall, we identified 16 relevant literature gaps.
Security in the context of configurable systems and their storage seems underexplored and only to a small extent considered in a practice-oriented way, e.g., regarding relevant security standards. 
