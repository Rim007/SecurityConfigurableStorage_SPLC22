...
\newcommand{\searchString}[1]{\noindent \begin{center} \hspace*{0.5ex}\colorbox{lightgray}{\parbox{0.95\columnwidth}{{\texttt{#1}}}} \vspace{-.7em} \hspace*{0.5ex} \end{center}}
...
Overall, we identified 14 research opportunities, which we discuss in detail to guide future research.
...
Our mapping study aims to help both practitioners and researchers to understand the current state-of-the-art research, identify open issues, and guide future research.
\end{abstract}
