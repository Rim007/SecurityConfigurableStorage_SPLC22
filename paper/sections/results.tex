...
usually centralized, however cloud systems or service-oriented platform (SaaS) are concerned with distributed systems, but consist of databases which are actual centralized
distribution often considered from the overall software system perspective

Only a few approaches that are actual distributed, e.g. an intercloud system based on resources distributed across multiple clouds~\cite{leite2016autonomic}.

problem - definition of cloud systems (actual medium vs. environment)
...
The ISO 27000 series, precisely ISO/IEC 27000~\cite{ISOIEC270002018} and ISO/IEC 27001~\cite{ISOIEC270012013}, are mentioned in two publications~\cite{fernandez2015patterns,garcia2015software}.
...
\citet{preuveneers2016systematic} referred to the secure payment standards PCI DSS and PA DSS. 
\citet{fernandez2015cloud} described SAML to securely exchange authentication and authorization data.
Moreover, \citet{shaaban2019ontology} referenced IEC 62443~\cite{IEC62443} and IEEE 1686~\cite{IEEE1686} in the context of their configurable production system.
