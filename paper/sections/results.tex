...
Fourth, the results which are concerned with the variability of the SPL-based configurable systems are described, including variability foucs, projection, verification, evolution, and tools support of the proposed systems.
...
gain, a huge majority of the publications covers the
problem space (20). For example, Mellado and Mouratidis [68] ex-
...
as the mapping between both. For instance, Peldszus et al. [79]
