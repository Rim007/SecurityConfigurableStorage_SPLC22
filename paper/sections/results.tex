...
In one paper, no concrete structure could be extracted.
...
Cloud systems or service-oriented platforms (i.e., SaaS or IaaS) are usually referred as distributed (software) systems by definition.
...
We argue that only a few approaches are actual distributed in terms of storage, e.g., an intercloud system based on resources distributed across multiple clouds~\cite{leite2016autonomic}.
