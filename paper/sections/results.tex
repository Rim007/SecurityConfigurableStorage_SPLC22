...
Moreover, we found three papers where a classification was hardly possible, as they consider both perspectives, e.g., a security policy-driven software for Multi-T´tenant SaaS Services configurations~\cite{aouzal2019policy}.
...
Similar to the first perspective classification, we found publication considering both perspectives (4), e.g., using product-line techniques to configure robotics applications running on a configurable cloud~\cite{gherardi2014software}.
