...
10 publications focus on the application of product-line techniques to realize certain security concerns (SPL $\rightarrow$ Security), e.g., security configurations of cyber-physical systems~\cite{varela2020definition}.
...
Only a few approaches that are actual distribute, e.g. an intercloud system based on resources distributed across multiple clouds~\cite{leite2016autonomic}.
