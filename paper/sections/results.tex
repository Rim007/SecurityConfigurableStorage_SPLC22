...
\begin{table*}[t]
	\caption{\todo{@Jacob: Not sure, maybe two or three smaller tables are better (nah, if it fits, its fine, I actually think this table is good, provides one concise overview, but the papers should be ordered by something :)}}
