...
\noindent\textbf{Storage:}	
	...
	\item \textbf{Stored data} indicating whether or which data is (securely) stored by a storage system.
    \end{itemize}\smallskip
    
\noindent\textbf{Security:}	  
    \begin{itemize}[nosep]
	\item \textbf{Standard} a publication refers to (e.g., ISO 27001~\cite{ISOIEC27001:2013}).
