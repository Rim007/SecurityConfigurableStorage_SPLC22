...
\noindent\textbf{Security:}	  
	...
	\item \textbf{Mitigation techniques} proposed or implemented to mitigate the impact of cyber-attacks and to achieve certain security goals (e.g., Intel SGX~\citep{Costan2016IntelExplained}).
	\end{itemize}\smallskip
