...
This way, we are able to extract concrete research gaps and new directions. 
...
In this context, a duplicate removal was conducted (i.e., removing 29 papers) and our selection criteria were employed on titles and abstracts, resulting in 76 papers for the full-text analysis. 
...
This way, we classified recurring information in the extracted data and accurately synthesized common themes for each data category.
The selection and analysis process was fully performed by the first author.
However, created categories and extraction results were adjusted based on discussions with the second author.
Subsequent interpretations of the results and derivations (i.e., research opportunities) were developed by the first three authors in discussion.
