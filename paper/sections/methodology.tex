...
\noindent\textbf{Security:}	  
	...
	\item \textbf{Mitigation techniques} implemented or proposed to achieve certain security goals (e.g., Intel Software Guard Extensions~\citep{Costan2016IntelExplained}).
	\end{itemize}\smallskip
