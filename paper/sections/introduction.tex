...
In this paper, we are particularly interested in such publications, since the data storage of a configurable system is also a major target for cyber attacks and feature interactions may reveal secrets~\citep{gamundani2018review,bamrara2015evaluating}.
...
\begin{itemize}[nosep,leftmargin=*]
	...
	\item A discussion of what properties have been researched and what properties require further investigations.
	
	\item An open-access repository including our detailed study results to increase the overall comprehensibility and ensure replicability.\footnote{\url{https://github.com/Rim007/replicationPackage_splc22}\label{ft:repo}}
\end{itemize}
