...
While each feature ideally provides a functionality that increases the value of a system, it is also more complex to manage such configurable systems~\citep{pohl2005software,Apel2013FOSPL,Kenner2021MappingStudy}. 
...
In this paper, we are particularly interested in such papers, since the data storage of a configurable system is also a major target for cyber attacks and feature interactions may lead to data breaches~\citep{gamundani2018review,bamrara2015evaluating}.
...
We conducted a systematic mapping study~\cite{Kitchenham2015EvidenceSLR}, aiming to address this research gap.
...
\begin{itemize}[nosep,leftmargin=*]
	...
	\item An open-access repository including our detailed study results to increase the overall comprehensibility and ensure replicability.\footnote{\url{https://www.dropbox.com/s/bvogapqktalxx60/analysis_sheet_SPLC22.csv?dl=0}\label{ft:repo}}
\end{itemize}
