...
While each feature ideally provides functionalities that increase the value of a system, it is also more complex to manage such configurable systems~\citep{pohl2005software,Apel2013FOSPL,Kenner2021MappingStudy}. 
...
\begin{itemize}[nosep,leftmargin=*]
	...
	\item An open-access repository including our detailed study results to increase the overall comprehensibility and ensure replicability.\footnote{\url{https://doi.org/10.5281/zenodo.6631417}\label{ft:repo}}
\end{itemize}
