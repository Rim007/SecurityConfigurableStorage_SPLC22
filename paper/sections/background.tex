...
Usually, such systems rely on concepts, methods, and techniques related to SPL~\cite{Apel2013FOSPL,pohl2005software}.
Variability in SPL is managed through the implementation of mechanisms (i.e., mainly variability models such as feature models) to organize and document variability and existing relationships.~\cite{Kang1990FODA,Apel2013FOSPL,Czarnecki2012CoolFeatures,Schaefer2012SoftwareDiversity}
...
According to these established standards, security is a characteristic of a software system aimed to protect its stored or processed data or information against a wide range of threats caused by attacks, vulnerabilities, errors (i.e., bugs), or even nature (e.g., in the context of hardware)~\cite{ISOIEC250102011,ISOIEC270002018}.
...
According to the ISO/IEC 27000 series~\cite{ISOIEC270002018} and ISO/IEC 25010~\cite{ISOIEC250102011}, three goals are particularly relevant which are known as the CIA triad~\cite{lundgren2019defining,samonasCIAStrikesBack2014}:
\begin{description}
