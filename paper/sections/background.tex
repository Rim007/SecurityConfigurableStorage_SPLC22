...
A configurable system is characterized by a number of  (diverse) features (i.e., user-visible functions) that can be customized (i.e., configured) to meet specific (customer) requirements, hardware constraints, or even legal requirements.
