...
If a decentralized storage provides (close) coordination between independent units, it is called a distributed storage~\cite{van2002distributed,wu2017distributed}, e.g., inter-cloud environments relying on a variety of storages~\cite{celesti2010security,leite2016autonomic}. 
...
Outsourcing solutions often serve as an underlying technology based on which data storing and processing functionalities can be implemented, leading to service-based systems or infrastructures; usually called Software as a Service (SaaS) or Infrastructure as a Service (IaaS)~\cite{lee2009quality,kulkarni2012cloud,serrano2015infrastructure}.
