...
In this paper, we reported a systematic mapping study to provide an overview understanding of security in the context of configurable data storages.
...
In future work, we aim to expand on this study to improve our understanding of the concepts, processes, and relationships of configurable systems and data storages, aiming to provide a conceptual framework.
For instance, one objective is to assess the impact of the binding time of variability, i.e., discussing security-related differences of configurability at design time and runtime.
Moreover, we plan to analyze and compare the technological structure and the different layers' impact of "regular" and configurable storages to develop techniques and security patterns supporting the engineering and evolution of configurable storages.
