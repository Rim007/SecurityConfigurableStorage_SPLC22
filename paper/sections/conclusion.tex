...
In future work, we aim to expand on this study to improve our understanding of the concepts, processes, and relationships of configurable systems and data storages (e.g., the impact of variability binding time), aiming to provide a conceptual framework.
Moreover, we plan to analyze and compare the technological structure of "regular" and configurable storages to develop techniques and security patterns supporting the engineering and evolution of configurable storages.
