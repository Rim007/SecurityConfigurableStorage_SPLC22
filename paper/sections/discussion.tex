...
Referring to Figure ~\ref{fig:taxonomy}, we state that most of the analyzed configurable systems do not provide actual configurable storages.
...
Thus, \textbf{(LG\textsubscript{17})} \emph{the research area of configurable storages seems under-explored} since storage is usually interpreted as a part of a system rather than as an individual system with requirements regarding variability.
