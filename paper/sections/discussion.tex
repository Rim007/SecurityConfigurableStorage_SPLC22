...
However, it is not always clear what exactly a security measure refers to, although there exist categorizations of security controls, e.g., provided by NIST~\cite{securityprivacycontrols2020}. 
