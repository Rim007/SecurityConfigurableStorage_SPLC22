...
Although we searched in three databases (i.e., \textsc{Scopus}, \textsc{IEEE Xplore}, and the \textsc{ACM Guide to Computing Literature}), we are aware that the smaller the number of included papers, the higher the potential impact of erroneous classifications.
