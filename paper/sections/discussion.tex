...
In detail, some authors described their work in great detail, while others only mentioned actually essential properties (concrete encryption algorithms) or described them only briefly.
